...
#define DEFAULT_ROF_EYES_ON ROF_UNCAPPED // no cap
#define DEFAULT_ROF_EYES_OFF 2 // 8bps
// Register max values
...
// Note: At some point I'm going to add a second register for each ROF setting 
// so you can set the integer and fraction values separately and not have to click so many times
#define REGISTER_ROF_ON_MAX 82 // ( 1 = unlimited, 2 = 8bps, 3 = 8.25, 4 = 8.5, ... 82 = 20bps )
#define REGISTER_ROF_OFF_MAX 18
...
#define REGISTER_ROF_ON 6
#define REGISTER_ROF_OFF 7
